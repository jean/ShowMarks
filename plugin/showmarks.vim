...
if !exists('g:showmarks_ignore_bt'   ) | let g:showmarks_ignore_bt    = ""   | endif
...
noremap <silent> m :exe 'norm! m'.nr2char(getchar())<bar>call <sid>ShowMarks()<CR>
...
fun! s:ShowMarks()
	...
	\ || ((match(g:showmarks_ignore_bt,   &buftype) > -1) && (&buftype != "") )
		return
	endif
